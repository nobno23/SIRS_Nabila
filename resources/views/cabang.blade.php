    ...
    <div id="wrapper">
        ...
        <div id="page-content-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1>Cabang Rumah Sakit</h1>
                        <p>Berikut adalah daftar cabang rumah sakit<br><br> Buka 24 jam</p>
                        <p>Melayani wilayah Pekanbaru dan area sekitarnya<code>layanan telpon 1 500 088</code>.</p>
                    </div>
                    <table>
                        <thead>
                           <tr>
